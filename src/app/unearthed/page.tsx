...
export default function Home() {
  ...
  return (
    <div className="unearthed-archive min-h-screen bg-white">
      ...
      `}</style>
      {/* Navigation */}
      <div className="fixed top-0 left-0 right-0 z-50"><SiteHeader active="unearthed" /></div>
      <nav className="fixed top-[88px] max-[700px]:top-[118px] left-0 right-0 bg-white/90 backdrop-blur-sm z-50 border-b border-gray-100">
      ...
      <section className="min-h-screen pt-[228px] max-[700px]:pt-[258px] pb-12 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-yellow-100 via-yellow-50 to-amber-50">
