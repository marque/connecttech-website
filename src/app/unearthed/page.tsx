...
export default function Home() {
  ...
  return (
    <div className="unearthed-archive min-h-screen bg-white">
      <style jsx>{`
        @keyframes spin {
      ...
      `}</style>
      {/* Navigation */}
      <div className="fixed top-0 left-0 right-0 z-50 h-[104px] max-[700px]:h-[106px] bg-[#0c0d0e] border-b border-[#f5c51830] shadow-[inset_0_2px_#f5c518]"><SeasonNav active="unearthed" /></div>
      <nav className="fixed top-[104px] max-[700px]:top-[106px] left-0 right-0 bg-white/90 backdrop-blur-sm z-50 border-b border-gray-100">
      ...
      <section className="min-h-screen pt-[244px] max-[700px]:pt-[246px] pb-12 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-yellow-100 via-yellow-50 to-amber-50">
        <div className="max-w-5xl mx-auto text-center">
          {/* Team Logo/Badge */}
          <div className="mb-8">
            <div className="inline-block bg-yellow-400 text-black text-lg font-bold px-6 py-2 rounded-full mb-6 shadow-lg">
              UNEARTHED™ · 2025–26 season archive
            </div>
      ...
      {/* Media Section */}
      <section id="media" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-yellow-200">
              ...
              <div className="mt-4 text-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-black px-6 py-3 rounded-full font-bold transition"
                >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-yellow-200">
              ...
              <a
                href="https://www.youtube.com/watch?v=-0zeB7dXUrc"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/30 group-hover:bg-black/40 transition flex items-center justify-center">
                  <div className="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-yellow-200">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-2xl font-bold text-gray-900">Mentioned by @archaeologyTo</h3>
              </div>
              <div className="rounded-xl overflow-hidden border border-gray-200" style={{ minHeight: 480 }}>
                <iframe
